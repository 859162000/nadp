(function ($, window, document, undefined) {
    ...
    var CustomPagination = function (element, options) {
        ...
        this.options.totalPages = parseInt(this.options.totalPages,10);
        if (isNaN(this.options.totalPages)) {
            throw new Error('Total pages option is not correct!');
        }

        this.options.visiblePages = parseInt(this.options.visiblePages,10);
    ...
    $.fn.customPagination = function (option) {
        ...
        if (!data) $this.data('twbs-pagination', (data = new CustomPagination(this, options) ));
